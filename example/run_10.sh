...
echo "Make Feature Time:"
echo $MAKE_FEATURE_TIME | awk '{print int($1/60)":"int($1%60)}'
echo "Make Lab Time:"
echo $MAKE_LAB_TIME | awk '{print int($1/60)":"int($1%60)}'
echo "Training Time:"
echo $TRAINING_TIME | awk '{print int($1/60)":"int($1%60)}'
echo "Generate Time:"
echo $GENERATE_TIME | awk '{print int($1/60)":"int($1%60)}'